...
Dog = col2.selectbox("Dog Friendly",["Yes", "No"])
Kid = col3.selectbox("Kid Friendly",["Yes", "No"])
Review = st.text_area("What kind of hike do you feel like doing this morning?",'I want to do something that has ocean views, some flowers, is easy to do, and maybe some wildlife - Am I asking for too much?')
# image = None
